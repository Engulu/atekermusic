    ...
    <footer className="bg-card border-t border-border mt-auto">
      <div className="container py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Your premier destination for Eastern Uganda music. Discover, stream, and download the best of Teso, Bukedi, Busoga, and beyond.
            </p>
        ...
        <div className="border-t border-border mt-8 pt-8">
          ...
          <div className="text-center md:text-left mt-4 text-xs text-muted-foreground">
            <p>
              Developer: <span className="font-medium">Enocha Engulu</span> - I.T Specialist, Web Developer, App Developer & Software Engineer
            </p>
            <p className="mt-1">Based in Soroti, Eastern Uganda</p>
          </div>
        </div>
      </div>
    </footer>
