      ...
      <div className="container py-8 max-w-4xl">
        ...
        <Card className="p-8 space-y-6">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">
              Ateker Music is currently a free platform. All music is available for free download to users. There is no revenue sharing at this time. Artists benefit from exposure, promotion, and building their fan base. Future monetization features may be introduced with separate agreements.
            </p>
          </section>
