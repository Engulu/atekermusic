...
export default function Register() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      await signUp({ name, email, password, phone, location: locationField, nin, bio })
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-primary/5 via-background to-background p-4">
      <Card className="w-full max-w-md p-8">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-card-foreground mb-2">Create your artist account</h1>
          <p className="text-muted-foreground">Sign up to share your music</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 mb-6">
          ...
          <div>
            <label htmlFor="location" className="block text-sm font-medium text-card-foreground mb-2">Location</label>
            <Input
              id="location"
              type="text"
              required
          ...
          <div>
            <label htmlFor="nin" className="block text-sm font-medium text-card-foreground mb-2">National ID Number</label>
            <Input
              id="nin"
              type="text"
              required
          ...
          <div>
            <label htmlFor="bio" className="block text-sm font-medium text-card-foreground mb-2">Bio</label>
            <Input
              id="bio"
              type="text"
              required
        ...
        <div className="mt-6 text-center">
          <Link href="/">
            <a className="text-sm text-muted-foreground hover:text-primary">← Back to home</a>
          </Link>
        </div>
      </Card>
    </div>
