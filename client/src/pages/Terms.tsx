    ...
    <Layout>
      <div className="container py-8 max-w-4xl">
        ...
        <Card className="p-8 space-y-6">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-card-foreground mb-3">5. Free Downloads</h2>
            <p className="text-muted-foreground leading-relaxed">
              All music on Ateker Music is available for free download for personal use. Commercial use of downloaded music requires explicit permission from the copyright holder (artist).
            </p>
          </section>

          <section>
            <h2 className="text-2xl font-semibold text-card-foreground mb-3">6. Disclaimer</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-card-foreground mb-3">7. Limitations</h2>
            <p className="text-muted-foreground leading-relaxed">
          ...
          <section>
            <h2 className="text-2xl font-semibold text-card-foreground mb-3">8. Revisions</h2>
            <p className="text-muted-foreground leading-relaxed">
